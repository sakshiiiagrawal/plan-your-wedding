...
export const TEMPLATES: Record<string, TemplateDefinition> = {
  ...
  album: {
    ...
    kind: 'website',
    name: 'Golden Album',
    tagline: 'Photo-first mosaic hero and a full masonry gallery',
    parts: [
      HERO_PART,
      { id: 'gallery', label: 'Gallery' },
      { id: 'story', label: 'Our Story' },
    ...
    recommendedPaletteIds: ['noir', 'porcelain', 'onyx', 'sage'],
    component: lazy(() => import('./templates/Album')),
  },
  journey: {
    id: 'journey',
    kind: 'website',
  ...
  monogram: {
    ...
    kind: 'website',
    name: 'Monogram',
    tagline: 'Minimal luxe one-pager — restraint is the identity',
    parts: [
      HERO_PART,
      { id: 'countdown', label: 'Countdown' },
      { id: 'story', label: 'Our Story' },
    ...
    defaultPaletteId: 'mandala',
    recommendedPaletteIds: ['mandala', 'noir', 'onyx', 'regal-teal'],
    component: lazy(() => import('./templates/Monogram')),
  },
  matinee: {
    id: 'matinee',
    kind: 'website',
    name: 'Vintage Matinee',
    tagline: 'Retro film-poster hero, ticket-stub events, grain overlay',
    parts: [
      HERO_PART,
      { id: 'story', label: 'Our Story' },
      { id: 'events', label: 'Events' },
    ...
    defaultPaletteId: 'bordeaux',
    recommendedPaletteIds: ['bordeaux', 'onyx', 'emerald', 'heirloom'],
    component: lazy(() => import('./templates/Matinee')),
  },
  reel: {
    id: 'reel',
    kind: 'invite',
  ...
  scroll: {
    ...
    kind: 'invite',
    name: 'Royal Scroll',
    tagline: 'Tap-to-unroll parchment intro with mandala ornaments',
    parts: [
      HERO_PART,
      { id: 'envelope', label: 'Opening scroll', overlay: true },
      { id: 'story', label: 'Our Story' },
      { id: 'countdown', label: 'Countdown' },
      { id: 'events', label: 'Event slides' },
      { id: 'gallery', label: 'Photo reel' },
    ...
    defaultPaletteId: 'royal',
    recommendedPaletteIds: ['royal', 'mandala', 'heirloom', 'desert'],
    component: lazy(() => import('./templates/RoyalScroll')),
  },
  boarding: {
    id: 'boarding',
    kind: 'invite',
  ...
  polaroid: {
    ...
    kind: 'invite',
    name: 'Polaroid Stack',
    tagline: 'Stacked polaroids spring-scatter to reveal the hero',
    parts: [
      HERO_PART,
      { id: 'envelope', label: 'Polaroid scatter', overlay: true },
      { id: 'story', label: 'Our Story' },
      { id: 'gallery', label: 'Photo reel' },
      { id: 'events', label: 'Event slides' },
      { id: 'rsvp', label: 'RSVP' },
    ...
    defaultPaletteId: 'meadow',
    recommendedPaletteIds: ['meadow', 'blush', 'lavender', 'sage'],
    component: lazy(() => import('./templates/Polaroid')),
  },
  card: {
    id: 'card',
    kind: 'invite',
